...
//create separate class for drawing arcs and lines, index , x, y
ArcsAndLines al;
...
void draw() {
  ...
  ellipse(width/2+(65/2), height/2, 3, 3);
  ellipse(width/2+(65/2), height/2+65, 3, 3);
  ellipse(width/2, height/2+(65/2), 3, 3);
  ellipse(width/2+65, height/2+(65/2), 3, 3);

  image(al.imgs[18], width/2, height/2);
  image(al.imgs[19], width/2, height/2);
}
